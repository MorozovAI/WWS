...
<nav class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    <div class="container">
        <a href="claims" class="navbar-brand"><img src="/resources/images/icon-meal.png"> <spring:message code="app.title"/></a>
                ...
                <li class="nav-item">
                   <%-- <sec:authorize access="isAuthenticated()">
                        <form:form class="form-inline my-2" action="logout" method="post">
                            ...
                            &lt;%&ndash;<a class="btn btn-info mr-1" href="profile"><sec:authentication property="principal.userTo.name"/> <spring:message code="app.profile"/></a>
                           &ndash;%&gt; <button class="btn btn-primary my-1" type="submit">
