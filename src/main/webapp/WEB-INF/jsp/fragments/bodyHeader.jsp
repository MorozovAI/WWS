...
<nav class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    <div class="container">
        <a href="claims" class="navbar-brand"><img src="/resources/images/WWS-logo2.png"> <spring:message
                code="app.title"/></a>
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="form-inline my-2" action="logout" method="post">
                            ...
                            <sec:authorize access="hasRole('ADMIN')">
                                <a class="btn btn-info mr-1" href="dealers"><spring:message code="dealer.title"/></a>
                                <a class="btn btn-info mr-1" href="users"><spring:message code="user.title"/></a>
                            </sec:authorize>
                            <a class="btn btn-info mr-1" href="profile"><sec:authentication
                                    property="principal.user.email"/></a>
